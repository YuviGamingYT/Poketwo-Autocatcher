...
const allowedChannels = [1116531919224578159]; // Add your allowed channel IDs to this array or leave it like [] if you want to it to catch from all channels
...
client.on('ready', () => {
    ...
    function spam() {
        ...
        channel.send(result + "(i don't know what i do) ")
